...
class Telegram
{
     ...
     * @throws TelegramException
     */
    public function enableMySql(array $credentials, int $admin_user_id = 0, string $table_prefix = '', string $encoding = 'utf8mb4'): Telegram
    {
        $this->pdo = DB::initialize($credentials, $this, $admin_user_id, $table_prefix, $encoding);
